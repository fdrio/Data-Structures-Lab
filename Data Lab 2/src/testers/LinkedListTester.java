...
//		listTester("Testing the Double Linked Dummy Header and Trailer List: ",
//				new LLIndexList<Integer>(new DLDHDTList<Integer>()));
		
		listTester("Testing the Singly with Last and First Linked List", new LLIndexList<Integer>(new SLFLList<Integer>()));
